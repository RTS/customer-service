package com.gigantes.customer.web.rest;

import static org.assertj.core.api.Assertions.assertThat;

import com.gigantes.customer.IntegrationTest;
import com.gigantes.customer.config.EmbeddedKafka;
import com.gigantes.customer.config.KafkaSseConsumer;
import com.gigantes.customer.config.KafkaSseProducer;
...
class CustomerKafkaResourceIT {
    ...
    void producesMessages() throws InterruptedException {
        client.post().uri("/api/customer-kafka/publish?message=value-produce").exchange().expectStatus().isNoContent();
    ...
    void consumesMessages() {
        ...
        String value = client
            .get()
            .uri("/api/customer-kafka/consume")
